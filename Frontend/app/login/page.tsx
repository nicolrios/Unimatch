  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Inicia sesion para conectar con tus companeros de estudio
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="bg-secondary border-border hover:bg-secondary/80">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-primary/40 rounded-full blur-[128px]" />
        ...
        <div className="relative z-10 flex items-center justify-center w-full p-12">
          <div className="glass rounded-3xl p-8 max-w-md">
            <blockquote className="text-lg text-foreground mb-4">
              &ldquo;UniMatch me ayudo a encontrar companeros de estudio de Japon y Alemania. 
              Ahora entiendo mejor las Bases de Datos gracias a diferentes perspectivas.&rdquo;
            </blockquote>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-foreground">Maria Lopez</div>
                <div className="text-sm text-muted-foreground">Estudiante de Informatica, UNAM</div>
              </div>
            </div>
          </div>
        </div>
